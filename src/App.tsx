              ...
              element={
                <div className="text-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center items-center">
                    ...
                    >
                      <img src="https://raw.githubusercontent.com/Mahendran8080/Mini-Games/refs/heads/main/images/rock-paper-scissors.png" alt="Game 1" className="w-full h-48 object-cover rounded-lg mb-4" />
                    ...
                    <Link
                      ...
                      className="bg-gray-800 p-6 rounded-lg shadow-lg hover:bg-purple-600 transition duration-300 flex flex-col items-center"
                    >
                      <img src="https://raw.githubusercontent.com/Mahendran8080/Mini-Games/refs/heads/main/images/man.png" alt="Game 2" className="w-full h-48 object-cover rounded-lg mb-4" />
                    ...
                    <Link
                      ...
                      className="bg-gray-800 p-6 rounded-lg shadow-lg hover:bg-purple-600 transition duration-300 flex flex-col items-center"
                    >
                      <img src="https://raw.githubusercontent.com/Mahendran8080/Mini-Games/refs/heads/main/images/memory.png" alt="Game 3" className="w-full h-48 object-cover rounded-lg mb-4" />
